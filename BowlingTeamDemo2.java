// program to demonstrate an instance of the BowlingTeamclass
// application file for exercise on pages 386 - 391
//Author Lani Hurley
//Date 9/28/2021
// *program requires BowlingTeam.java file to execute
...
public class BowlingTeamDemo2
{
    public static void main(String[] args)
    {
        ...
        for(y = 0; y < NUM_TEAMS; ++y)
        {
            ...
            {
                System.out.print("Please enter team member's name >> ");
                name = input.nextLine();
        ...
        System.out.print("\n\nPlease enter a team name to see its roster >>");
        name = input.nextLine();
